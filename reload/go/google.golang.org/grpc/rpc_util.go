...
func setCallInfoCodec(ctx context.Context, c *callInfo) error { // 3milebeach
	...
	if c.contentSubtype == "" {
		//log.Logger.PrintlnWithCaller("meta: %+v", ctx.Value(tracer.ContextMetaKey{})) // 3milebeach begins
